...
class Model(object):
    def __init__(self, configs):
        ...
        if configs.model_name in networks_map:
            ...
            self.network = Network(tuple(configs.in_shape), configs.hid_S,
                                   configs.hid_T, configs.N_S, configs.N_T).to(configs.device)
        else:
